# dextinity-admin-chart

Helm chart for a Dextinity Admin Microservice.
...
```bash
helm install my-release oci://ghcr.io/vivid-planet/charts/dextinity-admin --version 1.0.0
```
...
This chart continues `comet-admin` 2.2.0 from
